    ...
    <>
      <motion.div
        ...
        <motion.div
          ...
          <motion.span 
          variants={Motions.fadeIn("left", "tween", 0.04, 0.2)}
          className='text-xl font-semibold dark:text-neutral-300 '>Hi, there👋</motion.span>
          <motion.span 
          variants={Motions.fadeIn("up", "tween", 0.07, 0.7)}
          className='text-7xl font-bold text-amber-500 dark:text-purple-500'>Glenn Pray</motion.span>
          <motion.div 
          variants={Motions.textVariants(0.4)}
        ...
        <motion.div 
        variants={Motions.slideIn("right", "tween", 0.04, 0.7)}
